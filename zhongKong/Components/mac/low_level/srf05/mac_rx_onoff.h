...
#include "hal_board.h"
#define MAC_DEBUG_TURN_ON_RX_FILTER()    HAL_TURN_ON_RFRX_FILTER()
#define MAC_DEBUG_TURN_OFF_RX_FILTER()   HAL_TURN_ON_RFTX_FILTER()
#else
#define MAC_DEBUG_TURN_ON_RX_FILTER()
#define MAC_DEBUG_TURN_OFF_RX_FILTER()
#endif
