...
/* edge interrupt */
#define HAL_KEY_SW_2_EDGEBIT  BV(0) /* Port0 intputs 0-7 interrupt edge configration */
...
#define HAL_KEY_SW_3_INP      P0INP
/* edge interrupt */
#define HAL_KEY_SW_3_EDGEBIT  BV(0) /* Port0 intputs 0-7 interrupt edge configration */
...
#define HAL_KEY_SW_3_ICTLBIT  BV(4) /* P0IEN - P0.4 enable/disable bit */
...
#define HAL_KEY_SW_4_INP      P1INP
/* edge interrupt */
#define HAL_KEY_SW_4_EDGEBIT  BV(2) /* Port1 intputs 4-7 interrupt edge configration */
...
#define HAL_KEY_SW_4_ICTLBIT  BV(5) /* P1IEN - P1.5 enable/disable bit */
...
/* edge interrupt */
#define HAL_KEY_SW_5_EDGEBIT  BV(3) /* Port2 intputs 0-4 interrupt edge configration */
...
/* edge interrupt */
#define HAL_KEY_SW_6_EDGEBIT  BV(0) /* Port0 intputs 0-7 interrupt edge configration */
...
void HalKeyPoll (void)
{
  ...
  */
  ...
  else
  {
    ...
    else if((HalKeyCurrentKeys ==HAL_KEY_SW_2)&& HAL_PUSH_BUTTON2())
    {

      keys |= HAL_KEY_SW_2;
      if(HalKeyRead()&HAL_KEY_SW_1)
        shift = HAL_KEY_STATE_SHIFT;
    }
    ...
    else if((HalKeyCurrentKeys ==HAL_KEY_SW_4)&& HAL_PUSH_BUTTON4())
    {
...
HAL_ISR_FUNCTION( halKeyPort0Isr, P0INT_VECTOR )
{
  ...
  if (HAL_KEY_SW_2_PXIFG & HAL_KEY_SW_2_BIT)
  {
    ...
    HalKeyCurrentKeys = HAL_KEY_SW_2;
  }
...
HAL_ISR_FUNCTION( halKeyPort1Isr, P1INT_VECTOR )
{
  ...
  {
    halProcessKeyInterrupt();
    HalKeyCurrentKeys = HAL_KEY_SW_4;
  }
