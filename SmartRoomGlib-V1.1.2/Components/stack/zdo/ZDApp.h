...
#endif
#define ZDO_REJOIN_ENDDEVICE      0x2000
...
extern uint16 zdappHoldKeys;
extern bool StartFirstNwkJoin;
extern bool ForbitControlOnModeJoin;
/*********************************************************************
 * FUNCTIONS - API
 */
 ...
 */
extern uint8 ZDOInitDevice( uint32 startDelay );
...
/*
 * ZDApp_ResetTimerStartWithoutResetNwk
 *    - Start the reset timer.
 */
extern void ZDApp_ResetTimerStartWithoutResetNwk( uint16 delay );
/*
...
/*
 * ZDApp_SetMaxPollFailureRetries
 *    - Set max poll failure Retries for an end device
 *
 *    returns  none
 */
extern void ZDApp_SetMaxPollFailureRetries( uint8 maxPollFailureRetries );

extern  void ZDApp_SendMsg( uint8 taskID, uint8 cmd, uint8 len, uint8 *buf );

extern void UserAppJoinNetworkBlinkCallback(void);

extern uint8 UserAppAutoStartNwk(void);
/*********************************************************************
*********************************************************************/
